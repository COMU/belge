...
<xsl:template match="revhistory" mode="titlepage.mode">
  ...
  <table width="100%" summary="Revision history" cellspacing="3" cellpading="1" class="{name(.)}">
    <tr><td bgcolor="black" class="revoutline">
      <table width="100%" cellpadding="3" cellspacing="0" border="0">
        <tr><td bgcolor="white" class="revinline">
          <table width="100%" cellpadding="0" cellspacing="5" border="0" class="{name(.)}">
            <tr><th align="left" valign="top" colspan="{$numcols}" class="{name(.)}">
              <b>
                <xsl:call-template name="gentext">
