...
<xsl:template match="sect1">
  <dl><div class="{name(.)}"><dt>
    <xsl:call-template name="sect1.titlepage"/></dt><dd>
    <xsl:if test="($generate.section.toc != '0'
...
<xsl:template match="sect2">
  <dl><div class="{name(.)}"><dt>
    <xsl:call-template name="sect2.titlepage"/></dt><dd>
    <xsl:if test="($generate.section.toc != '0'
...
<xsl:template match="sect3">
  <dl><div class="{name(.)}"><dt>
    <xsl:call-template name="sect3.titlepage"/></dt><dd>
    <xsl:if test="($generate.section.toc != '0'
