...
<xsl:template match="refsect1">
  <dl><dt><h3><xsl:value-of select="title"/></h3>
  <xsl:call-template name="anchor"/></dt>
  <dd><xsl:apply-templates/></dd></dl>
</xsl:template>

<xsl:template match="refsect2">
  <dl><dt><h4><xsl:value-of select="title"/></h4>
  <xsl:call-template name="anchor"/></dt>
  <dd><xsl:apply-templates/></dd></dl>
</xsl:template>

<xsl:template match="refsect3">
  <dl><dt><h5><xsl:value-of select="title"/></h5>
  <xsl:call-template name="anchor"/></dt>
  <dd><xsl:apply-templates/></dd></dl>
</xsl:template>
  ...
  <table cellspacing="3" cellpadding="3" width="100%" border="0">
    <tr>
      ...
      <td class="mheadfoot" align="center" width="50%">
        <xsl:if test="(./refmeta/refmiscinfo[@role='header'])">
          <b><xsl:value-of select="./refmeta/refmiscinfo[@role='header']"/></b>
        </xsl:if>
        <xsl:text> </xsl:text>
      </td>
  ...
  <table cellspacing="3" cellpadding="3" width="100%" border="0">
    <tr>
      <td class="mheadfoot" align="left" width="30%">
        <xsl:if test="(./refmeta/refmiscinfo[@role='footerleft'])">
          <b><xsl:value-of select="./refmeta/refmiscinfo[@role='footerleft']"/></b>
        </xsl:if>
      </td>
      <td class="mheadfoot" align="center" width="40%">
        <xsl:if test="(./refmeta/refmiscinfo[@role='footermid'])">
          <b><xsl:value-of select="./refmeta/refmiscinfo[@role='footermid']"/></b>
        </xsl:if>
      </td>
